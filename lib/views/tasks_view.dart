                ...
                children: [
                  Wrap(
                    ...
                    children: [
                      ...
                      _filterChip('To Do', todoTasks.length, Icons.radio_button_unchecked),
                      _filterChip('In Progress', inProgressTasks.length, Icons.timelapse),
                      _filterChip('Done', doneTasks.length, Icons.check_circle),
                    ],
                  ),
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: () {
                      ...
                      Provider.of<AppViewModel>(context, listen: false).addTask(
                        StudyTask(
